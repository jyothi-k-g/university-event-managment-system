...
<html lang="en">
  ...
  <body>
      ...
      <h2 class="mb-4" style="marggin-bottom:20px;">Organization Overview</h2>
      <div class="row">
  ...
  <img src="images/committee.jpg" style="width:130px; height:120px;margin-left:23.5%;">
    <h5 class="card-title" style="font-size:19px;">	Committees</h5>
    <div style="margin-top:10px;"></div>
    <h6 class="card-subtitle mb-2 text-muted" style="margin-top:10px;font-size:17px;">Total committees</h6>
    <?php
  ...
  <img src="images/members.png" style="width:130px; height:120px;margin-left:23.5%;">
    <h5 class="card-title" style="font-size:19px;">	Members</h5>
    <div style="margin-top:10px;"></div>
    <h6 class="card-subtitle mb-2 text-muted" style="margin-top:10px;font-size:17px;">Total members</h6>
    <?php
