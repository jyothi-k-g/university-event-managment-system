...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM stu WHERE email='$email' AND password='$password'";
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css" integrity="sha384-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">
    ...
    <div class="container" style="width:70%;;border:1px solid #a6a6a6;border-radius: 2%;">
        ...
        <h1 style="padding-left:16%;padding-top:36%;color:#fff;font-family: Times New Roman, Times, serif;font-size: 40px;" > WELCOME BACk to Students portal</h1>
